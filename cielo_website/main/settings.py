...
APPLICATION_SET_DOMAIN = os.environ.get("APPLICATION_SET_DOMAIN", "cielo.viloforge.com")
...
MIDDLEWARE = [
    ...
    "webapp.middleware.CieloAccessMiddleware",  # Check for cielo.access permission
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "filename": os.path.join(LOG_BASE_DIR, "cielo_website.log"),
            "formatter": "verbose",
        ...
        "debug_file": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOG_BASE_DIR, "cielo_website_debug.log"),
            "formatter": "verbose",
            "filters": ["require_debug_true"],
            "maxBytes": 10485760,  # 10MB
            "backupCount": 3,
        ...
        "error_file": {
            "level": "ERROR",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOG_BASE_DIR, "cielo_website_errors.log"),
            "formatter": "verbose",
        ...
        "performance_file": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOG_BASE_DIR, "cielo_website_performance.log"),
            "formatter": "json",
            "maxBytes": 10485760,  # 10MB
            "backupCount": 5,
        },
        "security_file": {
            "level": "INFO",
            "class": "logging.handlers.RotatingFileHandler", 
            "filename": os.path.join(LOG_BASE_DIR, "cielo_website_security.log"),
            "formatter": "verbose",
            "maxBytes": 5242880,  # 5MB
            "backupCount": 10,
        },
